...
const Faq = () => {
  ...
  return (
    <div id="faq" className="py-20 px-12 md:px-16 bg-sky-200">
      <h1 className="text-4xl font-bold mb-3">
        <span className="text-blue-800">Frequently Asked</span> Question
      </h1>
      <section className="">
          ...
          <div className="mt-12 space-y-8">
            <div className="rounded-lg">
              ...
              >
                ...
                {firstQuestion ? (
                  <span className="text-blue-800 bg-gray-100 rounded-full">
                    <svg
                  ...
                  <span className="text-white bg-blue-800 rounded-full">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="w-6 h-6"
                      fill="none"
